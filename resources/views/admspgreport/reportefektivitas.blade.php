...
<h1 class="mt-4">Team Report Efektivitas Area</h1>
            <ol class="breadcrumb mb-4">
                <li class="breadcrumb-item"><a >Dashboard</a></li>
                <li class="breadcrumb-item active">Report Efektivitas Reports</li>
            </ol>
 
 </div>
<hr>
<form id="dailyreport-form" method="POST" action="{{ route('reportefektivitas.penjualan') }}">
    @csrf
    <div class="card mb-2">
            ...
            <div class="row g-2">
                <div class="col-md-6 mb-3">
                    <div class="form-floating">
                        <input type="date" min="1" name="tanggalawal" id="tanggalawal" class="form-control" value="{{ old('tanggalawal') }}" required>
                        <label for="tanggalawal">Tanggal Mulai</label>
                    </div>
                </div>
                <div class="col-md-6 mb-3">
                    <div class="form-floating">
                        <input type="date" min="1" name="tanggalakhir" id="tanggalakhir" class="form-control" value="{{ old('tanggalakhir') }}" required>
...
<div class="table-responsive">
    ...
    <thead class="thead-dark">
        <tr>
            ...
            <th>ECC<small  style="font-size: 10px"> Target 120</small></th></th>
            <th>Pack Selling<small  style="font-size: 10px"> Target 120</small></th></th>
